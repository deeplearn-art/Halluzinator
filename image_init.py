...
def perlin_ms(octaves=[1, 1, 1, 1], width=2, height=2, grayscale=False):
...
def initial_img(option,dim):
  if option == "perlin":
      return generate_perlin(dim)
  elif option == "perlin grayscale":
      return generate_perlin(dim,grayscale=True)